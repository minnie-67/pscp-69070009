...
```text
รับ start กับ end แล้วสร้าง List prime ไว้เก็บจำนวนเฉพาะ และสร้าง prime_num ไว้นับจำนวนเฉพาะ
จากนั้นใช้ for วนดูตัวเลขทุกตัวตั้งแต่ start ถึง end
โปรแกรมจะเช็คว่าตัวเลขนั้นหารด้วย 2, 3, 5 หรือ 7 ลงตัวหรือเปล่า ถ้าหารลงตัว ก็จะเช็คต่อว่าเป็น 2, 3, 5 หรือ 7 เองไหม เพราะตัวเลขอันนี้เป็นจำนวนเฉพาะ
ถ้าเป็น 2, 3, 5 หรือ 7 ก็จะเอาไปใส่ใน prime และเพิ่ม prime_num
ส่วนถ้าเป็น 1 จะไม่ทำอะไร เพราะ 1 ไม่ใช่จำนวนเฉพาะ
ถ้าเลขนั้นไม่ได้หารด้วย 2, 3, 5 หรือ 7 ลงตัว โปรแกรมจะถือว่าเป็นจำนวนเฉพาะ และเอาไปเก็บใน List
สุดท้ายคือถ้ามีจำนวนเฉพาะ ก็จะแสดงออกมา และแสดงจำนวนทั้งหมดด้วย prime_num
```
...
```text
เช็คว่าช่วง 10–20 มีจำนวนเฉพาะอะไรบ้าง
```
...
```text
เช็คกรณีที่ในช่วงมีเลข 2, 3, 5, 7 ซึ่งเป็นจำนวนเฉพาะที่โปรแกรมกำหนดให้ตรวจเป็นกรณีพิเศษ
```
