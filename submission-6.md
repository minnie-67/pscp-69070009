...
```text
a คือจำนวนอิฐก้อนเล็ก ก้อนละ 1 หน่วย
b คือจำนวนอิฐก้อนใหญ่ ก้อนละ 5 หน่วย
goal คือความยาวที่เราต้องการ
ตรง big = min(b, goal // 5) คือหาจำนวนอิฐใหญ่ที่สามารถใช้ได้มากที่สุด โดยต้องไม่เกินจำนวนที่มี และต้องไม่ทำให้ความยาวเกิน goal
จากนั้น remain คือความยาวที่ยังเหลืออยู่หลังจากใช้อิฐใหญ่ไปแล้ว
ถ้าความยาวที่เหลือไม่เกินจำนวนอิฐเล็กที่เรามี ก็สามารถสร้างความยาว goal ได้ เลยแสดง remain ออกมา
แต่ถ้าอิฐเล็กไม่พอ ก็แสดง -1
```
...
```text
มีอิฐเล็ก 4 ก้อน และอิฐใหญ่ 1 ก้อน
```
