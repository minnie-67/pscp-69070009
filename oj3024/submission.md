...
```text
ก็inputคะแนนรวมกับค่าสูงสุดมาก่อนโดยใช้float เป็นจำนวนจริง จากนั้นเราอยากหา ค่าที่ต่ำที่สุด โดยการเอาคะแนนรวมลบกับค่าสูงสุดกำลังสอง และเราไม่อยากให้ค่าน้อยสุดติดลบ จึงใช้ifถ้าค่าน้อยสุดน้อยกว่า0ให้ค่าน้อยสุดเท่ากับ0 จากนั้นก็ใช้ifต่อ ถ้าค่าสูงสุดลบกับค่าต่ำสุดแล้วค่าห่างกันมากกว่า2ให้print Surprising แต่ถ้าไม่ใช่ให้print not surprising
```
...
```text
ตอนแรกทำตามขั้นตอนเลยแต่ว่าตอนแรกที่ส่งไปมันไม่ผ่านเพราะ โจทย์อยากไม่อยากได้ค่าติดลบ แต่ต้องมาใช้if ถ้าค่าต่ำสุดมันน้อยกว่า0ให้เท่ากับ0เลย
```
...
```text
ใช้เหมือนแผนแรกเลย แต่แค่เติมif ถ้าค่าต่ำสุดมันน้อยกว่า0ให้เท่ากับ0
```
...
```text
ลองใส่คะแนนรวมเป็น40และค่าสูงสุดเป็น20
```
...
```text
ลองใส่คะแนนรวมเป็น100และค่าสูงสุดเป็น20
```
...
```text
ลองใส่คะแนนรวมเป็น15และค่าสูงสุดเป็น6
```
