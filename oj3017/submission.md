...
```text
ก็คือเริ่มจากinputราคาอาหารเข้ามาก่อน จากนั้นให้ตัวแปรserviceเก็บเป็น0ก่อน จากนั้นใช้ifถ้าราคาอาหารที่ใส่มาน้อยกว่า500ให้serviceเป็น50บาท และถ้าราคาอาหารมากกว่า10000ให้serviceเท่ากับ1000 และถ้าราคาอาหารน้อยกว่าหรือเท่ากับ0 ให้serviceเป็น0 และelse ให้service = ราคาอาหาร หาร10 แล้วก็มาคิดvatต่อ ให้vatเนี่ยเท่ากับserviceคูณกับprice และคูณด้วย0.07 จากนั้นคิดราคาทั้งหมดที่ต้องจ่าย ก็คือ service + vat + price = ราคาทั้งหมดที่ต้องจ่าย และปริ้นราคาทั้งหมดออกมาโดยใช้.2fเพื่อให้เป็นทศนิยมสองตำแหน่งตามโจทย์
```
...
```text
ก็คือinputก่อนแล้วก็ใช้if else แต่ว่าตอนแรกยังงงเรื่องการคิดเปอร์เซ็น จากนั้นเลยให้เพื่อนสอนต่อ
```
...
```text
ใช้if elseตามที่คิดไว้เลย แต่พวกตัวเลขและสูตรการคิดให้เพื่อนช่วยสอน
```
...
```text
ถ้าใส่ราคาเป็น0 ผลจะออกมาเป็นยังไง
```
...
```text
แล้วถ้าราคาอาหารติดลบละ จะออกมาเป็นเท่าไหร่
```
...
```text
ถ้าใส่ราคา1000บาท ผลรับจะได้เท่าไหร่
```
...
```text
ช่วยเรื่องสูตรและตัวเลข
```

คุณยังทำอะไรด้วยตนเอง

```text
เพื่อนแค่สอน ที่เหลือทำเอง
```
