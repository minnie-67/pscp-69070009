...
```text
รับจำนวนคำสั่งทั้งหมดมาเก็บไว้ใน n แล้วกำหนด total ให้เริ่มที่ 0 จากนั้นใช้ for วนรับคำสั่งตามจำนวน และแต่ละรอบจะเก็บคำสั่งไว้ใน d ถ้า d เป็น "+" ก็จะเพิ่มคะแนนเข้าไป 10 คะแนน แต่ถ้าเป็น "-" ก็จะลดคะแนนลง 5 คะแนน ทำแบบนี้ไปเรื่อย ๆ จนครบทุกคำสั่ง สุดท้ายก็แสดงคะแนนรวมทั้งหมดออกมาด้วย print(total)
```
...
```text
เช็คว่าโปรแกรมสามารถ บวกและลบคะแนนสลับกัน
```
...
```text
เช็คกรณีที่ เริ่มจากการติดลบก่อน แล้วค่อยได้คะแนนกลับมา
```
...
```text
เช็คกรณีที่มีแต่ + ว่าคะแนนจะ เพิ่มครั้งละ 10 ถูกต้อง
```
