...
```text
ตอนแรกก็รับค่า a, b, d และ r เข้ามา แล้วสร้าง count = 0 ไว้สำหรับนับจำนวน
ละก็ใช้ for วนตั้งแต่ a ถึง b โดย b + 1 เพราะ range จะไม่รวมตัวสุดท้าย
แล้วใช้ % เพื่อหาเศษจากการหาร ถ้า i % d เท่ากับ r ก็แสดงว่าตัวเลขนั้นตรงตามเงื่อนไข เลยเพิ่ม count ขึ้น 1
พอวนครบทุกตัวแล้ว ก็แสดงค่า count ออกมา
```
...
```text
ตัวเลขในช่วง 1–10 ที่หาร 3 แล้วเหลือเศษ 1 คือ
```
...
```text
หาตัวเลขในช่วง 5–20 ที่หาร 4 ลงตัว
```
...
```text
หาตัวเลขในช่วง 10–30 ที่หาร 5 แล้วเหลือเศษ 2
```
