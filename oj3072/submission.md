...
```text
ก็คือให้inputเข้ามาเป็นตัวเล็กเท่านั้น แล้วให้นับว่าในคำที่inputมา มีaeiouอยู่อย่างละกี่ตัว
```
...
```text
เริ่มจากให้inputคำภาษาอังกิตเป็นตัวพิมพ์เล็กหมด จากนั้นสร้างlistเก็บตัวaeiouไว้ แล้วก็สร้างlistอีกอันเป็น0 5ตัว จากนั้นใช้for loop ถ้้าตัวอักษรในinputมีตัวaให้ นับตัวที่0ในlistเพิ่มมา1 แล้วก็ทำแบบนี้จนถึงตัวที่4ก็คือu แล้วก็ใช้for loop เพื่อให้outputออกมา ถ้าcountมันมากกว่า0 ให้พิมพ์aeiou และมีกี่ตัว
```
