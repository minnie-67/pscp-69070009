...
```text
ตอนแรกโปรแกรมรับจุดเริ่มต้นกับจุดปลายทางมา แล้วใช้ .upper() เพื่อเปลี่ยนให้เป็นตัวพิมพ์ใหญ่ทั้งหมด เช่น bkk ก็จะกลายเป็น BKK
จากนั้นรับน้ำหนักของของมาเก็บไว้ใน weight
ตัวแปร fee จะเก็บ ค่าบริการเริ่มต้น ส่วน fee_w จะเก็บ ค่าขนส่งต่อน้ำหนัก 1 หน่วย
แล้วใช้ if กับ elif เช็กว่าเส้นทางที่ผู้ใช้กรอกมาตรงกับเส้นทางไหน เช่น ถ้า BKK ไป CNX ก็จะกำหนดค่าตามเส้นทางนั้น
ถ้าเจอเส้นทางที่ตรงกัน found จะเป็น True
จากนั้นถ้าเจอเส้นทาง โปรแกรมจะคำนวณราคาจาก ค่าบริการ + ค่าตามน้ำหนัก × น้ำหนักสินค้า
แล้วใช้ :.2f เพื่อให้แสดงราคาเป็นทศนิยม 2 ตำแหน่ง
แต่ถ้าไม่มีเส้นทางที่กำหนดไว้ ก็จะแสดงคำว่า Error
```
