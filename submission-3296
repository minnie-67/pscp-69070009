...
```text
ตอนแรกเรารับค่าสีของสีแรกมาเก็บไว้ใน colour1 แล้วก็รับค่าสีที่สองมาเก็บไว้ใน colour2
ละก็สร้าง op เป็น List ว่างไว้สำหรับเก็บค่าสีที่ผสมแล้ว
แล้วใช้ for วน 3 รอบ เพราะ RGB มี 3 ค่า
ในแต่ละรอบ จะเอาค่าของสีแรกกับสีที่สองในตำแหน่งเดียวกันมาบวกกัน แล้วหาร 2 เพื่อหาค่าเฉลี่ย จากนั้นใช้ append เอาค่าที่ได้ไปเก็บใน op
สุดท้ายใช้ print(*op) เพื่อแสดงค่าที่ผสมออกมา โดยให้แต่ละค่าเว้นวรรคกัน
```
...
```text
เอา RGB ของสีทั้ง 2 สีมาหาค่าเฉลี่ยทีละตัว
```
...
```text
เอาค่า RGB แต่ละตำแหน่งมาบวกกันแล้วหาร 2
```
