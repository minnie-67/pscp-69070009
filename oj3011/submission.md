...
```text
ก็คือให้รับค่าแม่สี สองสี และให้ตัวอักษรตัวแรกเป็นตัวพิมพ์ใหญ่ ใช้ if ถ้ารับค่าสีแรกเป็นred และ สีที่สองเป็นblue ให้printสีที่กำหนดไว้ในโจทย์คือviolet ทำแบบนี้กับทุกสี และถ้ารับค่า2ค่าออกมาเป็นสีเดียวกันให้printสีนั้น ใช้else ถ้าinputมาไม่ตรงกับที่ใส่ไว้เช่น รับค่าสีอื่นมา ให้print error 
```
...
```text
ตอนแรกทำเองแล้วลองส่งแต่มันขึ้นแดง เพราะไม่ได้ตั้งให้ตัวแรกเป็นตัวพิมพ์ใหญ่และไม่ได้ใส่ว่าถ้ารับค่าสีเดียวกันให้printสีนั้น
```
...
```text
ก็คือทำเหมือนแผนแรกเลยแต่จะมีจุดผิดคือ ให้ตัวอักษรแรกเป็นตัวพิมพ์ใหญ่และถ้ารับค่าสีสองสีเหมือนกันให้ปริ้นสีนั้น
```
...
```text
ถ้าใส่สีซ้ำกันจะออกมาเป็นสีอะไร
```
...
```text
ถ้าลองพิมพ์ตัวพิมพ์เล็กพิมพ์ใหญ่ผสมกัน ค่าจะออกมาตามที่ตั้งไหม
```
...
```text
ถ้าใส่สีอื่นที่ไม่ใช่แม่สีที่กำหนด จะออกมาเป็นยังไง
```
...
```text
ช่วยบอกว่าทำไมมันถึงผิด เช่น ต้องให้ตัวอักษรตัวแรกเป็นตัวพิมพ์ใหญ่นะ
```

คุณยังทำอะไรด้วยตนเอง

```text
ที่เหลือทำเองหมด แค่เพื่อนบอกตรงที่ผิด
```
