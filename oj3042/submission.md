...
```text
ก็คือรับตัวเลขมาแล้วถ้าเลขมันไม่ลงท้ายด้วย0ก็ทำการหารสิบโดยไม่เอาเศษแล้วคูณต่อด้วยสิบจะได้เลขที่ลงท้ายด้วย0 จากนั้นเอาเข้าfor loop คือให้เริ่มจากค่าที่เราแปลงแล้ว ให้ลดลงที่ละสิบ จนถึง0 จากนั้นก็ปริ้นiออกมา ให้อยู่ในบรรทัดเดียวกัน
```
...
```text
ก็คือรับค่ามาแล้วเปลีี่ยนค่าให้ลงท้ายด้วย0 จากนั้นใช้for loop โดยให้ลดลงที่ละสิบจนถึง0 จากนั้นปริ้นออกมาโดยให้อยู่ในบรรทัดเดียวกัน
```
