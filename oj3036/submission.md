...
```text
คือให้รับค่า x แล้วใช้ while loop หาเลข floor ที่ยกกำลังสองแล้วมีค่ามากกว่า x จากนั้นก็คำนวณว่าเลขนั้นห่างจาก x เท่าไรในตัวแปร far และคำนวณจำนวนห้องด้วย ROOM = 2 * floor - 1 แล้วตรวจว่า far เป็นเลขคู่หรือไม่ ถ้าเป็นเลขคู่จะแสดง ROOM - 1 แต่ถ้าเป็นเลขคี่จะแสดง ROOM - 2
```
...
```text
รับค่าxมา กำหนดตัวแปรfloorให้เป็น1 เพิ่ม floor ทีละ 1 จนกว่า floor**2 จะมากกว่าหรือเท่ากับ x แล้วหาว่าfloor**2ห่างจากxเท่าไหร่ แล้วก็เช็คว่าfarเป็นเลขคู่ไหม
```
...
```text
ถ้าใส่25ผลลัพท์จะออกมาเป็นยังไง
```
...
```text
ถ้าใส่100ผลลัพท์จะออกมาเป็นยังไง
```
...
```text
ถ้าใส่2ผลลัพท์จะออกมาเป็นยังไง
```
...
```text
ช่วยสอนวิธีการทำ อธิบายโจทย์เพราะตอนแรกงงโจทย์มาก
```
