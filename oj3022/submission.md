...
```text
ให้inputอุณหภูมิเป็นจำนวนจริงมาก่อนโดยใช้float และinputหน่วย ตัวแรกคือตัวที่เราใช้เปลี่ยนและตัวที่สองคือตัวที่เราจะเปลี่ยนเป็นอันนี้ ก็คือเราจะเปลี่ยนทุกตัวให้เป็นcก่อนเพื่อที่จะได้เปลี่ยนเป็นตัวอื่นอีกที เริ่มจากใช้if ถ้าinput c เข้ามา ให้อุณภูมิเป็นเหมือนเดิม ที่เหลือก็เอามาจากโจทย์โดยเปลี่ยนตัวนั้นให้เป็นหน่วยc ต่อมาพอทุกอันเป็นcหมด ก็ใช้if ให้จากcเป็นตัวที่เราต้องการ และก็ทำกับทุกตัว เสร็จแล้วprintมันออกมาเป็นทศนิยม2ตำแหน่ง
```
