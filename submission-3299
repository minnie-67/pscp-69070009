...
```text
ตอนแรกเรากำหนด band เป็น 1 ก่อน ก็คือเริ่มจากแถวแรก
แล้วใช้ while เช็กว่าจำนวนดอกไม้ที่เรามีตอนนี้ยังไม่ถึง N หรือเปล่า
ถ้ายังไม่ถึง เราก็เพิ่ม band ขึ้นทีละ 1 แล้วคำนวณใหม่
ทำแบบนี้ไปเรื่อย ๆ จนกว่าจำนวนดอกไม้จะครบหรือเกิน N
สุดท้ายก็เอาค่า band ที่ได้ออกมา ซึ่งก็คือจำนวนแถวที่ต้องใช้
```
...
```text
เช็กว่าต้องใช้กี่แถวถึงจะมีดอกไม้ครบอย่างน้อย 10 ดอก
```
...
```text
เช็กว่าต้องใช้กี่แถวถึงจะมีดอกไม้ครบอย่างน้อย 20 ดอก
```
...
```text
เช็กว่าต้องใช้กี่แถวถึงจะมีดอกไม้ครบอย่างน้อย 50 ดอก
```
