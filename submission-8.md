...
```text
รับ member เพื่อเช็กว่าเป็นสมาชิกหรือไม่ แล้วรับ n ซึ่งเป็นจำนวนสินค้าที่ซื้อ
จากนั้นสร้าง total = Decimal("0") ไว้เก็บราคารวม แล้วใช้ for วนตามจำนวนสินค้า เพื่อรับราคาทีละรายการและเอามาบวกกัน
หลังจากได้ราคารวมแล้ว ก็เช็กเงื่อนไขส่วนลด
ถ้า member == "Y" หมายถึงเป็นสมาชิก จะลดราคา 5% โดยคูณ 0.95
แต่ถ้าไม่ใช่สมาชิก และซื้อของรวมตั้งแต่ 500 บาทขึ้นไป จะลด 3% โดยคูณ 0.97
หลังจากนั้นใช้ quantize() เพื่อปัดราคาให้เหลือทศนิยม 2 ตำแหน่ง และใช้ ROUND_HALF_UP ซึ่งเป็นการปัดเศษแบบทั่วไป
สุดท้ายก็แสดงราคาที่ต้องจ่ายออกมา
```
...
```text
ถ้าไม่เป็นสมาชิก แต่ซื้อครบ 500
```
...
```text
ถ้าไม่เป็นสมาชิก และยอดไม่ถึง 500
```
