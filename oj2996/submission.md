...
```text
คือรับตัวอักษรภาษาอังกฤษ 5ตัวอักษร แล้วก็ให้printข้อความโดยการprintเริ่มจากตัวที่5ก็คือtext4เพราะภาษาpythonเริ่มนับตั้งแต่0 ตัวที่5เลยเป็นตัวที่4 แล้วก็บวกข้อความต่อไปก็คือตัวที่4 ก็คือตัวที่3ของpython แล้วทำแบบนี้ไปเรื่องจนถึงตัวที่0 ของpython จากนั้นโจทย์ก็อยากได้ให้printออกมาตัวพิมพ์เล็กทั้งหมด เลยใช้คำสั่งlowerเพราะเมื่อรับค่ามาแม้จะเป็นตัวพิมพ์ใหญ่outputก็จะออกมาเป็นตัวพิมพ์เล็กทุกตัว
```
...
```text
อันนี้ลองเขียนเองตามความเข้าใจ แต่ส่งไปรอบแรกผิดเพราะเว้นบรรทัดเกิน ก็คือเริ่มจากinputข้อความมา5ตัว แล้วก็printจากตัวสุดท้ายก่อนแล้วค่อยๆไล่มาถึงตัวแรก จากนั้นก็ทำให้ตัวอักษรเป็นตัวพิมพ์เล็กโดยการใช้lower
```
...
```text
ใช้วิธีเดียวกับแผนแรกเลย แต่รอบแรกเว้นบรรทัดเกินไปหน่อย
```
...
```text
ใส่ตัวอักษร5ตัวเพื่อดูว่ามันไล่จากหลังไปหน้้าจริงไหม
```
...
```text
ตรวจสอบว่าถ้าพิมพ์ตัวอักษรตัวพิมพ์ใหญ่ไป จะออกมาเป็นพิมพ์เล็กจริงไหม
```
...
```text
ภ้าพิมพ์เกิน5ตัว จะออกมาเป็นยังไง
```
